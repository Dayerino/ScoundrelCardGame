...
Module {
    ...
    property stringList config: ["shared","plugin_manifest","intelcet","stack_protector","stack_clash_protection","libstdcpp_assertions"]
    property stringList qtConfig: ["shared","no-pkg-config","separate_debug_info","reduce_exports","openssl","release"]
    readonly property stringList enabledFeatures: ["version_tagging","shared","separate_debug_info","signaling_nan","thread","future","concurrent","dbus","opensslv30","shared","intelcet","stack_protector","stack_clash_protection","libstdcpp_assertions","shared","separate_debug_info","reduce_exports","openssl"]
    ...
    property path binPath: "C:/Qt/6.8.2/mingw_64/bin"
    property path installPath: "C:/Qt/6.8.2/mingw_64/bin"
    property path incPath: "C:/Qt/6.8.2/mingw_64/include"
    property path libPath: "C:/Qt/6.8.2/mingw_64/lib"
    property path installPrefixPath: "C:/Qt/6.8.2/mingw_64"
    property path libExecPath: "C:/Qt/6.8.2/mingw_64/bin"
    property path qmlLibExecPath: "C:/Qt/6.8.2/mingw_64/bin"
    property path pluginPath: "C:/Qt/6.8.2/mingw_64/plugins"
    property string mkspecName: "win32-g++"
    property path mkspecPath: "C:/Qt/6.8.2/mingw_64/mkspecs/win32-g++"
    ...
    property path docPath: "C:/Qt/Docs/Qt-6.8.2"
    property path translationsPath: "C:/Qt/6.8.2/mingw_64/translations"
    property string helpGeneratorLibExecPath: "C:/Qt/6.8.2/mingw_64/bin"
    ...
    property string libFilePathRelease: "C:/Qt/6.8.2/mingw_64/lib/libQt6Core.a"
    ...
    cpp.systemIncludePaths: ["C:/Qt/6.8.2/mingw_64/include","C:/Qt/6.8.2/mingw_64/include/QtCore"].concat(mkspecPath)
    cpp.libraryPaths: {
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? undefined : ["C:/Qt/6.8.2/mingw_64/lib/libQt6EntryPoint.a"]);
        }
